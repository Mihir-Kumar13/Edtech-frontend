    ...
    <div className="max-w-2xl mx-auto p-8 bg-gray-800 rounded-lg shadow-xl">
      ...
      <form className="space-y-6">
        ...
        <div className="flex items-center justify-center w-full">
          ...
          >
            {!thumbnail ? (
              <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-300">
                <svg
